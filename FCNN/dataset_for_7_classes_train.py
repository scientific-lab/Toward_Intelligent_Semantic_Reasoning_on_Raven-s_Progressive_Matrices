...
#         #print(self.imgs)
        path_dir='/nfs/h1/RAVEN/I-RAVEN/'
        Name1 =os.listdir(path_dir+'center_single') 
        Name2 =os.listdir(path_dir+'distribute_four') 
        Name3 =os.listdir(path_dir+'distribute_nine') 
        Name4 =os.listdir(path_dir+'in_center_single_out_center_single') 
        Name5 =os.listdir(path_dir+'in_distribute_four_out_center_single') 
        Name6 =os.listdir(path_dir+'left_center_single_right_center_single') 
        Name7 =os.listdir(path_dir+'up_center_single_down_center_single') 
            ...
            #for i in [0,1]:
                ...
                for j in range (0,len(Name1)):
                    if Name1[j][0:length]=='RAVEN_'+str(i)+'_' and Name1[j][-4:]=='.npz':
                        if 'train' in Name1[j] or 'val' in Name1[j]:
                            question.append(Path(path_dir+P[k]) / Name1[j])
                            answer.append(k)
            k+=1
