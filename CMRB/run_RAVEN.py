...
#Name_of_dir=['in_distribute_four_out_center_single','left_center_single_right_center_single','up_center_single_down_center_single']
# direct_to_dir=['/nfs/h1/RAVEN/I-RAVEN/','/nfs/h1/RAVEN/RAVEN-FAIR/']
#direct_to_dir=['/nfs/h1/RAVEN/RAVEN_ori/']
direct_to_dir=['D:\\zsk\\RAVEN\\RAVEN_ori\\']
savestr='raven_ori_cm2'
