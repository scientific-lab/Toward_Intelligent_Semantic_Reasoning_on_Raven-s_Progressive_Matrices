import numpy as np
from relation_position import relation_map_in,two_ship,three_ship,solve_r2_return,solve_r3_return
def CMP1(relationship_two_30,relationship_three_30,o,p,d,c):
