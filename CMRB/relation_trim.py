...
for L0 in range (4,8):
    for L1 in range (1,4):
        ...
        np.save('CM5\\ts2_final'+'_'+str(L0)+'_'+str(L1)+'.npy',relationship_two_30)
        np.save('CM5\\ts3_final'+'_'+str(L0)+'_'+str(L1)+'.npy',relationship_three_30)
        o,p=cal_al(relationship_two_30,relationship_three_30,L0,L1)
        print(o)
        print(p)
        np.save('CM5\\o_final'+str(L0)+'_'+str(L1)+'.npy',o)
        np.save('CM5\\p_final'+str(L0)+'_'+str(L1)+'.npy',p)
