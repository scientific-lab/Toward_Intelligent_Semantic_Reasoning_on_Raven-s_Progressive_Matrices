from generate_number import generate_Att_from_img,generate_Att_from_img_center_single,generate_Att_from_img_threebythree,generate_Att_from_img_in_out_single,generate_Att_from_img_outin4,generate_Att_from_img_leftright,generate_Att_from_img_updown
...
def solve_and_draw(data,draw,t):
    Answer=0
    ...
    if problem_set==1:
        Exist,Type,Color,Size,Angle,Exist_panel,Angle_panel,Color_panel,Size_panel,Type_panel=generate_Att_from_img(data,t)
