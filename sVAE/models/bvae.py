...
#         self.f1=nn.Linear(latent_dim, 8192)
#         self.f2=nn.Linear(8192, 29)
#         self.f3=nn.Linear(29, 8192)
#         self.f4=nn.Linear(8192, latent_dim)
